...
const MagicButton = ({
    title, icon, position, handleClick, target,rel, otherClasses
}: {
    title: string; icon: React.ReactNode, target?: string, rel?:string, position: string; handleClick?: () => void; otherClasses?: string;
}) => {
    return (
